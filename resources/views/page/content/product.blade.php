            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <ul>
                        ...
                        <li><b>Miễn phí ship:</b> <span>trong bán kính 3km hoặc đơn hàng trên 20kg</span></li>
                        <li><b>Liên lạc</b>
                            <div class="share">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab"
                                aria-selected="true">Về Sạch Foods</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                            <div class="product__details__tab__desc">
                                <p>Sạch Foods là đại lí bán sỉ và lẻ các loại thực phẩm tươi sống sạch như rau, củ, quả, thịt, hải sản, các gói hàng được trang trí theo yêu cầu của bạn thông qua số điện thoại (0913 411 308 hoặc 088 93 39 395) để được tư vấng một cách chính xác và nhanh nhất.  </p>
                                <p>Sản phẩm của chúng tôi được lấy từ các nhà cung cấp sạch có danh tiếng và lau đời vì vậy hãy mua hàng một cách thoải mái vì tất cả sản phẩm bạn đặt đã được chọn lọc một cách tỉ mĩ.</p>
