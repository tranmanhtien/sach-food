            ...
            <form action="{{route('admin.postaddProduct')}}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="name" placeholder="Nhập tên sản phẩm"
                               class="form-control">
                        @error('name')
                ...
                <div class="row form-group">
                    <div class="col col-md-3">
                        <label for="email-input" class=" form-control-label">Số lượng theo kg / gói</label>
                    </div>
                    <div class="col-12 col-md-9">
                        <input type="text" id="email-input" name="amount" placeholder="Nhập số lượng đơn vị kg / gói"
                               class="form-control">
                        @error('amount')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="row form-group">
                    <div class="col col-md-3">
                        <label for="text-input" class=" form-control-label">Giá thành sản phẩm trên 1kg hoặc gói</label>
                    </div>
                    <div class="col-12 col-md-9">
                        <input type="text" id="text-input" name="price"
                               placeholder="Nhập giá thành sản phẩm trên 1kg hoặc gói" class="form-control">
                        @error('price')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="general" id="textarea-input" rows="9" placeholder="Nhập thông tin sản phẩm"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="date" id="text-input" name="date" placeholder="Nhập ngày nhập hàng"
                               class="form-control date" value="{{$date}}">
                        @error('date')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
