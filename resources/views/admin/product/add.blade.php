        ...
        <form action="{{route('admin.postaddProduct')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
           @csrf 
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="email-input" name="amount" placeholder="Nhập số lượng đơn vị kg / gói" class="form-control">
                    @error('amount')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" name="price" placeholder="Nhập giá thành sản phẩm trên 1kg hoặc gói" class="form-control">
                    @error('price')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
